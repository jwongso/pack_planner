...
namespace PackPlanner
{
    ...
    /// </summary>
    public readonly record struct Item : IComparable<Item>
    {
        /// <summary>
        /// The item identifier
        /// </summary>
        ...
        /// <summary>
        /// Reusable comparer to sort items by length descending (long to short)
        /// </summary>
        public static IComparer<Item> LengthDescendingComparer { get; } = Comparer<Item>.Create(
            (a, b) => b.Length.CompareTo(a.Length)
        );

        // Operators comparing length only
